...
begin
  ...
  with CL.AddClassN(CL.FindClass('TComponent'),'TDynamicDll') do
  begin
    RegisterMethod('Constructor Create( AOwner : TComponent)');
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TComponent'),'TPythonInputOutput') do
  begin
    RegisterMethod('Constructor Create( AOwner : TComponent)');
...
procedure SIRegister_PythonEngine(CL: TPSPascalCompiler);
begin
  CL.AddTypeS('TPythonVersionProp', 'record DllName : string; RegVersion : stri'
   +'ng; APIVersion : Integer; end');
 ...
 CL.AddConstantN('READONLY','LongInt').SetInt( 1);
 ...
 CL.AddConstantN('PY_WRITE_RESTRICTED','LongInt').SetInt( 4);
  CL.AddTypeS('TPyMemberType', '( mtShort, mtInt, mtLong, mtFloat, mtDouble, mt'
   +'String, mtObject, mtChar, mtByte, mtUByte, mtUShort, mtUInt, mtULong, mtSt'
   +'ringInplace, mtObjectEx )');
  CL.AddTypeS('TPyMemberFlag', '( mfDefault, mfReadOnly, mfReadRestricted, mfWr'
   +'iteRestricted, mfRestricted )');
 ...
 CL.AddConstantN('TAB','Char').SetString( #09);
  ...
  CL.AddTypeS('PySequenceMethods', 'record sq_length : lenfunc; sq_concat : bin'
   ...
   +'tains : objobjproc; sq_inplace_concat : binaryfunc; sq_inplace_repeat : ss'
   +'izeargfunc; end');
  ...
  CL.AddTypeS('PyObject', 'record ob_refcnt : NativeInt; ob_type : PPyTypeObjec'
   +'t; end');
  CL.AddTypeS('_frozen', 'record name : PAnsiChar; code : PByte; size : Integer'
   +'; end');
  ...
  CL.AddTypeS('wrapperbase', 'record name : PAnsiChar; wrapper : wrapperfunc; d'
   +'oc : PAnsiChar; end');
  ...
  CL.AddTypeS('PyMethodDescrObject', 'record ob_refcnt : NativeInt; ob_type : P'
   +'PyTypeObject; d_type : PPyTypeObject; d_name : PPyObject; d_method : PPyMe'
   +'thodDef; end');
  ...
  CL.AddTypeS('PyMemberDescrObject', 'record ob_refcnt : NativeInt; ob_type : P'
   +'PyTypeObject; d_type : PPyTypeObject; d_name : PPyObject; d_member : PPyMe'
   +'mberDef; end');
  ...
  CL.AddTypeS('PyGetSetDescrObject', 'record ob_refcnt : NativeInt; ob_type : P'
   +'PyTypeObject; d_type : PPyTypeObject; d_name : PPyObject; d_getset : PPyGe'
   +'tSetDef; end');
  ...
  CL.AddTypeS('PyModuleDef', 'record m_base : PyModuleDef_Base; m_name : PAnsiC'
   ...
   +'load : inquiry; m_traverse : traverseproc; m_clear : inquiry; m_free : inq'
   +'uiry; end');
  ...
  CL.AddTypeS('PPyInterpreterState', 'Pointer');
  CL.AddTypeS('PPyThreadState', 'Pointer');
  CL.AddTypeS('PNode', '^node // will not work');
  CL.AddTypeS('node', 'record n_type : smallint; n_str : PAnsiChar; n_lineno : '
   +'integer; n_col_offset : integer; n_nchildren : integer; n_child : PNode; e'
   +'nd');
  CL.AddTypeS('PPyCompilerFlags', '^PyCompilerFlags // will not work');
  CL.AddTypeS('PyCompilerFlags', 'record flags : integer; cf_feature_version : '
   +'integer; end');
 ...
 CL.AddConstantN('_PyDateTime_DATETIME_DATASIZE','LongInt').SetInt( 10);
  CL.AddTypeS('PyDateTime_Delta', 'record ob_refcnt : NativeInt; ob_type : PPyT'
   +'ypeObject; hashcode : NativeInt; days : Integer; seconds : Integer; micros'
   +'econds : Integer; end');
  CL.AddTypeS('PPyDateTime_Delta', '^PyDateTime_Delta // will not work');
  CL.AddTypeS('PyDateTime_TZInfo', 'record ob_refcnt : NativeInt; ob_type : PPy'
   +'TypeObject; end');
  ...
  CL.AddTypeS('_PPyDateTime_BaseTZInfo', '^_PyDateTime_BaseTZInfo // will not w'
   +'ork');
  ...
  CL.AddTypeS('_PPyDateTime_BaseDateTime', '^_PyDateTime_BaseDateTime // will n'
   +'ot work');
  CL.AddTypeS('PyDateTime_DateTime', 'record ob_refcnt : NativeInt; ob_type : P'
   +'PyTypeObject; hashcode : Integer; hastzinfo : Char; tzinfo : PPyObject; en'
   +'d');
 ...
 CL.AddConstantN('kMaxLineLength','LongInt').SetInt( 256);
  CL.AddTypeS('TSendDataEvent', 'Procedure ( Sender : TObject; const Data : Ans'
   +'iString)');
  CL.AddTypeS('TReceiveDataEvent', 'Procedure ( Sender : TObject; var Data : An'
   +'siString)');
  CL.AddTypeS('TSendUniDataEvent', 'Procedure ( Sender : TObject; const Data : '
   +'UnicodeString)');
  CL.AddTypeS('TReceiveUniDataEvent', 'Procedure ( Sender : TObject; var Data :'
   +' UnicodeString)');
 ...
 CL.AddConstantN('DEFAULT_DATETIME_CONVERSION_MODE','').SetString( dcmToTuple);
  ...
  CL.AddTypeS('TPathInitializationEvent', 'Procedure ( Sender : TObject; var Pa'
   +'th : string)');
  CL.AddTypeS('TSysPathInitEvent', 'Procedure ( Sender : TObject; PathList : PP'
   +'yObject)');
  CL.AddTypeS('TPythonFlag', '( pfDebug, pfInteractive, pfNoSite, pfOptimize, p'
   +'fVerbose, pfFrozenFlag, pfIgnoreEnvironmentFlag )');
  ...
  CL.AddTypeS('TDelphiMethodWithKW', 'Function ( self, args, keywords : PPyObje'
   +'ct) : PPyObject');
  CL.AddTypeS('TPythonEvent', 'Procedure ( Sender : TObject; PSelf, Args : PPyO'
   +'bject; var Result : PPyObject)');
  ...
  CL.AddTypeS('TBasicServices', 'set of ( bsGetAttr, bsSetAttr, bsRepr, bsCompa'
   +'re, bsHash, bsStr, bsGetAttrO, bsSetAttrO, bsCall, bsTraverse, bsClear, bs'
   +'RichCompare, bsIter, bsIterNext )');
  CL.AddTypeS('TNumberServices', 'set of ( nsAdd, nsSubtract, nsMultiply, nsRem'
   +'ainder, nsDivmod, nsPower, nsNegative, nsPositive, nsAbsolute, nsInvert, n'
   +'sLShift, nsRShift, nsAnd, nsXor, nsOr, nsInt, nsFloat, nsFloorDivide, nsTr'
   +'ueDivide, nsMatrixMultiply, nsBool )');
  CL.AddTypeS('TInplaceNumberServices', 'set of ( nsInplaceAdd, nsInplaceSubtra'
   +'ct, nsInplaceMultiply, nsInplaceRemainder, nsInplacePower, nsInplaceLShift'
   +', nsInplaceRShift, nsInplaceAnd, nsInplaceXor, nsInplaceOr, nsInplaceFloor'
   +'Divide, nsInplaceTrueDivide, nsInplaceMatrixMultiply )');
  CL.AddTypeS('TSequenceServices', 'set of ( ssLength, ssConcat, ssRepeat, ssIt'
   +'em, ssAssItem, ssContains, ssInplaceConcat, ssInplaceRepeat )');
  CL.AddTypeS('TMappingServices', 'set of ( msLength, msSubscript, msAssSubscri'
   +'pt )');
  SIRegister_TTypeServices(CL);
  SIRegister_TPythonType(CL);
  CL.AddTypeS('TGetDataEvent', 'Procedure ( Sender : TObject; var Data : Varian'
   +'t)');
  CL.AddTypeS('TSetDataEvent', 'Procedure ( Sender : TObject; Data : Variant)');
  CL.AddTypeS('TExtGetDataEvent', 'Procedure ( Sender : TObject; var Data : PPy'
   +'Object)');
  CL.AddTypeS('TExtSetDataEvent', 'Procedure ( Sender : TObject; Data : PPyObje'
   +'ct)');
...
Begin Result := Self.EncodeString0(str); END;
...
begin
 ...
 S.RegisterDelphiFunction(@CleanString13, 'CleanString13', cdRegister);
 S.RegisterDelphiFunction(@CleanString14, 'CleanString14', cdRegister);
end;
...
begin
  ...
  begin
    ...
    RegisterMethod(@TPythonEngineEncodeString01_P, 'EncodeString01');
