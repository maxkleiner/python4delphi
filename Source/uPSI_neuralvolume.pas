...
begin
  ...
  with CL.AddClassN(CL.FindClass('TVolume'),'TNNetVolume') do
  begin
...
begin
  ...
  begin
    RegisterProperty('FData', 'array of T', iptrw);
    RegisterMethod('Constructor Create0( pSizeX, pSizeY, pDepth : integer; c : T);');
    RegisterMethod('Constructor Create1( pInput : array of T);');
    RegisterMethod('Constructor Create2( Original : array of byte);');
    RegisterMethod('Constructor Create3( Original : TVolume);');
    RegisterMethod('Constructor Create4( Original : TBits; pFalse : T; pTrue : T);');
    RegisterMethod('Constructor CreateAsBits5( Original : array of byte; pFalse : T; pTrue : T);');
    RegisterMethod('Constructor Create6( pSize : integer; c : T);');
    RegisterMethod('Constructor Create7( );');
    RegisterMethod('Procedure Fill( c : T)');
    RegisterMethod('Procedure FillForIdx( c : T; const aIdx : array of integer)');
    RegisterMethod('Procedure FillAtDepth( pDepth : integer; Value : T)');
    ...
    RegisterMethod('Function Get( x, y, d : integer) : T');
    RegisterMethod('Function GetAsByte( x, y, d : integer) : byte');
    RegisterMethod('Function GetRaw( x : integer) : T');
    RegisterMethod('Procedure SetRaw( X : integer; Value : T)');
    RegisterMethod('Procedure Store( x, y, d : integer; Value : T)');
    RegisterMethod('Procedure Add11( x, y, d : integer; Value : T);');
    RegisterMethod('Procedure Add12( Original : TVolume);');
    RegisterMethod('Procedure Add13( Value : T);');
    RegisterMethod('Procedure Add14( PtrA, PtrB : TNeuralFloatArrPtr; NumElements : integer);');
    RegisterMethod('Procedure AddAtDepth15( pDepth : integer; Value : T);');
    RegisterMethod('Procedure AddLayers16( A, B : TVolume);');
    RegisterMethod('Procedure Sub17( x, y, d : integer; Value : T);');
    RegisterMethod('Procedure Sub18( Original : TVolume);');
    RegisterMethod('Procedure Sub19( Value : T);');
    ...
    RegisterMethod('Procedure Mul23( x, y, d : integer; Value : T);');
    RegisterMethod('Procedure Mul24( Original : TVolume);');
    RegisterMethod('Procedure Mul25( PtrA, PtrB : TNeuralFloatArrPtr; pSize : integer);');
    RegisterMethod('Procedure Mul26( Value : T);');
    RegisterMethod('Procedure MulAtDepth27( pDepth : integer; Value : T);');
    RegisterMethod('Procedure Pow28( Value : T);');
    RegisterMethod('Procedure VSqrt( )');
    RegisterMethod('Procedure MulAdd29( Value : T; Original : TVolume);');
    RegisterMethod('Procedure MulMulAdd30( Value1, Value2 : T; Original : TVolume);');
    RegisterMethod('Procedure MulAdd31( Value : T; PtrB : TNeuralFloatArrPtr);');
    RegisterMethod('Procedure MulAdd32( Original1, Original2 : TVolume);');
    RegisterMethod('Procedure MulAdd33( PtrA, PtrB : TNeuralFloatArrPtr; Value : T; pSize : integer);');
    RegisterMethod('Procedure MulAdd34( PtrA, PtrB, PtrC : TNeuralFloatArrPtr; pSize : integer);');
    RegisterMethod('Procedure Divi35( x, y, d : integer; Value : T);');
    RegisterMethod('Procedure Divi36( Original : TVolume);');
    RegisterMethod('Procedure Divi37( Value : T);');
    RegisterMethod('Procedure ForceMinRange( Value : T)');
    RegisterMethod('Procedure ForceMaxRange( Value : T)');
    ...
    RegisterMethod('Procedure AddSaltAndPepper( pNum : integer; pSalt : T; pPepper : T; pColor : boolean)');
    ...
    RegisterMethod('Procedure Copy41( var Original : array of T);');
    RegisterMethod('Procedure Copy42( var Original : array of byte);');
    RegisterMethod('Procedure Copy43( Original : TBits; pFlase : T; pTrue : T);');
    ...
    RegisterMethod('Procedure Define( Original : array of T)');
    RegisterMethod('Function DotProduct44( Original : TVolume) : T;');
    RegisterMethod('Function DotProduct45( PtrA, PtrB : TNeuralFloatArrPtr; NumElements : integer) : Single;');
    RegisterMethod('Function SumDiff( Original : TVolume) : T');
    RegisterMethod('Procedure SumToPos( Original : TVolume)');
    RegisterMethod('Function GetDistanceSqr46( Original : TVolume) : T;');
    RegisterMethod('Function GetDistance47( Original : TVolume) : T;');
    RegisterMethod('Function SumAtDepth( pDepth : integer) : T');
    RegisterMethod('Function AvgAtDepth( pDepth : integer) : T');
    ...
    RegisterMethod('Function GetMin( ) : T');
    RegisterMethod('Function GetMax( ) : T');
    RegisterMethod('Function GetNonZero( ) : integer');
    RegisterMethod('Function GetMaxAbs( ) : T');
    RegisterMethod('Procedure GetMinMaxAtDepth( pDepth : integer; out pMin, pMax : T)');
    RegisterMethod('Function GetSum( ) : T');
    RegisterMethod('Function GetSumAbs( ) : T');
    RegisterMethod('Function GetSumSqr( ) : T');
    RegisterMethod('Function GetAvg( ) : T');
    RegisterMethod('Function GetVariance( ) : T');
    RegisterMethod('Function GetStdDeviation( ) : T');
    RegisterMethod('Function GetMagnitude( ) : T');
    ...
    RegisterMethod('Procedure InitUniform( Value : T)');
    RegisterMethod('Procedure InitGaussian( Value : T)');
    RegisterMethod('Procedure InitLeCunUniform( Value : T)');
    RegisterMethod('Procedure InitHeUniform( Value : T)');
    RegisterMethod('Procedure InitLeCunGaussian( Value : T)');
    RegisterMethod('Procedure InitHeGaussian( Value : T)');
    RegisterMethod('Procedure InitSELU( Value : T)');
    RegisterMethod('Function SaveToString( ) : string');
    RegisterMethod('Procedure LoadFromString( strData : string)');
    RegisterMethod('Procedure CopyAsBits56( var Original : array of byte; pFlase : T; pTrue : T);');
    RegisterMethod('Procedure ReadAsBits( var Dest : array of byte; Threshold : T)');
    RegisterMethod('Procedure SetClass57( pClass : integer; value : T);');
    RegisterMethod('Procedure SetClass58( pClass : integer; TrueValue, FalseValue : T);');
    ...
    RegisterMethod('Function SoftMax( ) : T');
    ...
    RegisterProperty('Data', 'T integer integer integer', iptrw);
    SetDefaultPropery('Data');
    RegisterProperty('AsByte', 'byte integer integer integer', iptr);
    RegisterProperty('Raw', 'T integer', iptrw);
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TList'),'TNNetList') do
  begin
...
(*----------------------------------------------------------------------------*)
Procedure TVolumeCopy41_P(Self: TVolume;  var Original : array of T);
Begin Self.Copy(Original); END;
...
(*----------------------------------------------------------------------------*)
procedure TVolumeFData_W(Self: TVolume; const T: array of T);
Begin Self.FData := T; end;

(*----------------------------------------------------------------------------*)
procedure TVolumeFData_R(Self: TVolume; var T: array of T);
...
procedure RIRegister_neuralvolume_Routines(S: TPSExec);
begin
 S.RegisterDelphiFunction(@CreateTokenizedStringList86, 'CreateTokenizedStringList86', cdRegister);
 S.RegisterDelphiFunction(@CreateTokenizedStringList87, 'CreateTokenizedStringList87', cdRegister);
 ...
 S.RegisterDelphiFunction(@NeuronForceMinMax88, 'NeuronForceMinMax88', cdRegister);
 S.RegisterDelphiFunction(@NeuronForceMinMax89, 'NeuronForceMinMax89', cdRegister);
...
begin
  ...
  begin
    ...
    RegisterVirtualMethod(@TVolumeResize8_P, 'Resize8');
    RegisterVirtualMethod(@TVolumeReSize9_P, 'ReSize9');
    RegisterVirtualMethod(@TVolumeReSize10_P, 'ReSize10');
    ...
    RegisterVirtualMethod(@TVolume.GetSum, 'GetSum');
    RegisterVirtualMethod(@TVolume.GetSumAbs, 'GetSumAbs');
    RegisterVirtualMethod(@TVolume.GetSumSqr, 'GetSumSqr');
